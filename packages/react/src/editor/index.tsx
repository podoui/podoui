...
const Editor = ({
  ...
  const handleEditorClick = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      if (
        (target.classList.contains("youtube-overlay") || target.closest(".youtube-container")) &&
        editorRef.current?.contains(target)
      ) {
        e.preventDefault();
        e.stopPropagation();
  ...
  return (
    ...
    >
      ...
      <div className={styles.toolbar}>
        ...
        {isToolbarItemEnabled("paragraph") && (
          <div className={styles.toolbarGroup}>
            ...
            >
              <span>
                {paragraphOptions.find((opt) => opt.value === textStyle.currentParagraphStyle)
                  ?.label || "문단 형식"}
              </span>
          ...
          <div className={styles.toolbarGroup}>
            <div style={{ position: "relative" }}>
              <button
                ...
                title={
                  alignOptions.find((opt) => opt.value === textStyle.currentAlign)?.label || "정렬"
                }
              >
                <i
                  className={
                    styles[
                      alignOptions.find((opt) => opt.value === textStyle.currentAlign)?.icon ||
                        "alignLeft"
                    ]
                  }
                />
                  ...
                  <div className={styles.imageOptions}>
                    <div className={styles.imageOptionRow}>
                      ...
                      <div className={styles.imageSizeButtons}>
                        <button
                          type="button"
                          className={imageEditor.imageWidth === "100%" ? styles.active : ""}
                          onClick={() => imageEditor.setImageWidth("100%")}
                        >
                          100%
                        </button>
                        <button
                          type="button"
                          className={imageEditor.imageWidth === "75%" ? styles.active : ""}
                          onClick={() => imageEditor.setImageWidth("75%")}
                        >
                          75%
                        </button>
                        <button
                          type="button"
                          className={imageEditor.imageWidth === "50%" ? styles.active : ""}
                          onClick={() => imageEditor.setImageWidth("50%")}
                        >
                          50%
                        </button>
                        <button
                          type="button"
                          className={imageEditor.imageWidth === "original" ? styles.active : ""}
                          onClick={() => imageEditor.setImageWidth("original")}
                        >
                          원본
                        </button>
                      </div>
                    ...
                    <div className={styles.imageOptionRow}>
                      ...
                      <div className={styles.imageAlignButtons}>
                        <button
                          type="button"
                          className={imageEditor.imageAlign === "left" ? styles.active : ""}
                          onClick={() => imageEditor.setImageAlign("left")}
                          title="왼쪽 정렬"
                        >
                        ...
                        <button
                          type="button"
                          className={imageEditor.imageAlign === "center" ? styles.active : ""}
                          onClick={() => imageEditor.setImageAlign("center")}
                          title="가운데 정렬"
                        >
                        ...
                        <button
                          type="button"
                          className={imageEditor.imageAlign === "right" ? styles.active : ""}
                          onClick={() => imageEditor.setImageAlign("right")}
                          title="오른쪽 정렬"
                        >
                    ...
                    <div className={styles.imageOptionRow}>
                      ...
                      <input
                        ...
                        onChange={(e) => imageEditor.setImageAlt(e.target.value)}
                        placeholder="이미지 설명..."
                      />
                    </div>
                  </div>
            ...
            <div style={{ position: "relative" }}>
              ...
              {youtubeEditor.isYoutubeDropdownOpen && (
                <div className={styles.imageDropdown}>
                  <div className={styles.imageTabSection}>
                    <div className={styles.imageTabButtons}>
                      <button type="button" className={styles.active} style={{ width: "100%" }}>
                        유튜브 URL
                      </button>
                    </div>
                  ...
                  <div className={styles.imageOptions}>
                    <div className={styles.imageOptionRow}>
                      ...
                      <div className={styles.imageSizeButtons}>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeWidth === "100%" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeWidth("100%")}
                        >
                          100%
                        </button>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeWidth === "75%" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeWidth("75%")}
                        >
                          75%
                        </button>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeWidth === "50%" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeWidth("50%")}
                        >
                          50%
                        </button>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeWidth === "original" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeWidth("original")}
                        >
                          원본
                        </button>
                      </div>
                    ...
                    <div className={styles.imageOptionRow}>
                      ...
                      <div className={styles.imageAlignButtons}>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeAlign === "left" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeAlign("left")}
                          title="왼쪽 정렬"
                        >
                          <i className={styles.alignLeft} />
                        </button>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeAlign === "center" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeAlign("center")}
                          title="가운데 정렬"
                        >
                          <i className={styles.alignCenter} />
                        </button>
                        <button
                          type="button"
                          className={youtubeEditor.youtubeAlign === "right" ? styles.active : ""}
                          onClick={() => youtubeEditor.setYoutubeAlign("right")}
                          title="오른쪽 정렬"
                        >
                          <i className={styles.alignRight} />
                        </button>
                  ...
                  <div className={styles.imageActions}>
                    <button
                      type="button"
                      onClick={youtubeEditor.closeYoutubeDropdown}
                      className={styles.default}
                    >
                      취소
                    </button>
                    <button
                      type="button"
                      onClick={youtubeEditor.insertYoutubeEmbed}
                      disabled={!youtubeEditor.youtubeUrl}
                      className={styles.primary}
                    >
                      삽입
                    </button>
        ...
        {codeView.isCodeView ? (
          ...
          <textarea
            ...
            style={{
              ...
              height:
                height === "contents" && codeView.savedEditorHeight
                  ? `${codeView.savedEditorHeight}px`
                  : undefined,
              resize: "none",
            }}
      ...
      {/* 검증 메시지 */}
      {validator && message && <div className={styles.validator}>{message}</div>}
      ...
      {linkEditor.isEditLinkPopupOpen && linkEditor.selectedLinkElement && (
        <div
          ...
          style={{
            position: "absolute",
            top:
              linkEditor.selectedLinkElement.offsetTop +
              linkEditor.selectedLinkElement.offsetHeight +
              5,
        ...
        >
          <div className={styles.editLinkContent}>
            ...
            <div className={styles.editLinkActions}>
              <button type="button" onClick={linkEditor.deleteLink} className={styles.danger}>
                링크 삭제
              </button>
              ...
              <div className={styles.imageEditContent}>
                <div className={styles.imageEditRow}>
                  ...
                  <div className={styles.imageSizeButtons}>
                    <button
                      type="button"
                      className={imageEditor.editImageWidth === "100%" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageWidth("100%")}
                    >
                      100%
                    </button>
                    <button
                      type="button"
                      className={imageEditor.editImageWidth === "75%" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageWidth("75%")}
                    >
                      75%
                    </button>
                    <button
                      type="button"
                      className={imageEditor.editImageWidth === "50%" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageWidth("50%")}
                    >
                      50%
                    </button>
                    <button
                      type="button"
                      className={imageEditor.editImageWidth === "original" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageWidth("original")}
                    >
                      원본
                    </button>
                  </div>
                ...
                <div className={styles.imageEditRow}>
                  ...
                  <div className={styles.imageAlignButtons}>
                    <button
                      type="button"
                      className={imageEditor.editImageAlign === "left" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageAlign("left")}
                      title="왼쪽 정렬"
                    >
                      <i className={styles.alignLeft} />
                    </button>
                    <button
                      type="button"
                      className={imageEditor.editImageAlign === "center" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageAlign("center")}
                      title="가운데 정렬"
                    >
                      <i className={styles.alignCenter} />
                    </button>
                    <button
                      type="button"
                      className={imageEditor.editImageAlign === "right" ? styles.active : ""}
                      onClick={() => imageEditor.setEditImageAlign("right")}
                      title="오른쪽 정렬"
                    >
                      <i className={styles.alignRight} />
                    </button>
                ...
                <div className={styles.imageEditRow}>
                  ...
                  <input
                    type="text"
                    value={imageEditor.editImageAlt}
                    onChange={(e) => imageEditor.setEditImageAlt(e.target.value)}
                    placeholder="이미지 설명..."
                  />
                </div>
                <div className={styles.imageEditActions}>
                  <button type="button" onClick={imageEditor.deleteImage} className={styles.danger}>
                    이미지 삭제
                  </button>
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button
                      type="button"
                      onClick={imageEditor.unselectImage}
                      className={styles.default}
                    >
                      취소
                    </button>
                    <button
                      type="button"
                      onClick={imageEditor.applyImageEdit}
                      className={styles.primary}
                    >
                      적용
                    </button>
      ...
      {youtubeEditor.isYoutubeEditPopupOpen &&
        ...
        (() => {
          // 유튜브의 wrapper 찾기
          const youtubeWrapper = youtubeEditor.selectedYoutube.parentElement?.classList.contains(
            "youtube-wrapper"
          )
          ...
          return (
            <div
              ...
              style={{
                ...
                left: Math.max(
                  10,
                  Math.min(wrapperRect.left + wrapperRect.width / 2 - 180, window.innerWidth - 370)
                ),
                zIndex: 9999,
                minWidth: "360px",
                maxWidth: "90%",
            ...
            >
              ...
              <div className={styles.imageOptions} style={{ marginBottom: "0" }}>
                ...
                <div className={styles.imageActions}>
                  <button
                    type="button"
                    onClick={youtubeEditor.deleteYoutube}
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button
                      type="button"
                      onClick={youtubeEditor.closeYoutubeEditPopup}
                      className={styles.default}
                    >
                      취소
                    </button>
                    <button
                      type="button"
                      onClick={youtubeEditor.applyYoutubeEdit}
                      className={styles.primary}
                    >
                      적용
                    </button>
        ...
        >
          ...
          <div className={styles.tableContextMenuItem}>
            ...
            >
              셀 배경색{" "}
              {tableEditor.selectedTableCells.length > 1
                ? `(${tableEditor.selectedTableCells.length}개)`
                : ""}
