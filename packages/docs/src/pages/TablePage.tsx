...
const USAGE_TABS: CodeTab[] = [
  ...
  },
  {
    ...
    label: "Hono",
    code:
      `import { Table } from "podo-ui/hono";\n\n` +
  ...
  return (
    <>
      ...
      <DocSection
        index={4}
        title="속성 (props)"
        description="podo-ui/react의 Table이 받는 속성이에요. 내용은 표준 thead·tbody·tr·th·td 마크업을 그대로 사용해 표 시맨틱과 접근성이 플랫폼에서 나와요. hover·pressed 행 상태는 브라우저 상호작용으로 표현돼요. 행·셀 단위 설정은 마크업에 data-* 속성으로 표시해요 — 아래 표의 data-align, data-disabled 항목을 참고하세요. React Native에는 표 레이아웃이 없어 FlatList 사용을 권장해요."
      >
        <SpecTable
          variant="props"
